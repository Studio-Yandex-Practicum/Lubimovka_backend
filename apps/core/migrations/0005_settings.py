# Generated by Django 3.2.7 on 2021-10-26 21:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_type', models.CharField(choices=[('BOOLEAN', 'Да/Нет'), ('TITLE', 'Заголовок/Описание'), ('TEXT', 'Текст'), ('URL', 'URL'), ('IMAGE', 'Картинка'), ('EMAIL', 'EMAIL')], max_length=40, verbose_name='Выбор поля настроек')),
