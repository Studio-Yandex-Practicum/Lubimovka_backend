    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('author_url', models.URLField(default=1, verbose_name='Ссылка на автора записи')),
                ('author_url_title', models.CharField(default=1, max_length=50, verbose_name='Подпись/название ссылки на автора')),
                ('description', models.TextField(max_length=500, verbose_name='Описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True)),
                ('description', models.TextField(max_length=500, verbose_name='Описание')),
                ('image', models.ImageField(blank=True, default='', upload_to=apps.content_pages.utilities.path_by_app_label_and_class_name, verbose_name='Заглавная картинка')),
                ('pub_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Дата публикации')),
                ('title', models.CharField(max_length=200, verbose_name='Заголовок')),
                ('is_draft', models.BooleanField(default=True, help_text='Поставьте отметку если это черновик', verbose_name='Черновик')),
            ],
