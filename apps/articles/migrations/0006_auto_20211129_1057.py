...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0012_add_settings'),
        ('articles', '0005_alter_newsitem_image'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='newsitem',
            name='image',
            field=models.ImageField(blank=True, default=1, upload_to=apps.content_pages.utilities.path_by_app_label_and_class_name, verbose_name='Заглавная картинка'),
