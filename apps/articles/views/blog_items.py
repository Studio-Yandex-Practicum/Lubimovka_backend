...
from apps.articles.selectors import blog_item_detail_get, blog_item_list_get
...
class BlogItemListAPI(APIView):
    ...
    def get(self, request):
        ...
        filtered_blog_items = blog_item_list_get(filters=filters_serializer.validated_data)
...
class BlogItemDetailAPI(APIView):
    ...
    def get(self, request, id):
        blog_item_detail = blog_item_detail_get(blog_item_id=id)
