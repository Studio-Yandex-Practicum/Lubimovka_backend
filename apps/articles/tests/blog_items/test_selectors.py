...
def test_selector_blog_item_detail_get_not_return_draft(simple_blog_item_not_published):
    """Selector should return 404 if `BlogItem` is draft."""
    blog_item_id = simple_blog_item_not_published.id
    with pytest.raises(Http404):
        blog_item_detail_get(blog_item_id)
...
def test_selector_blog_item_detail_get_type(blog_item_with_persons):
    ...
    blog_item = blog_item_detail_get(blog_item_id)
...
def test_selector_blog_item_detail_get_role_persons(blog_item_with_persons, persons):
