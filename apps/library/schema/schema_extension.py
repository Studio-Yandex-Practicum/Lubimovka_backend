...
ERROR_MESSAGES_FOR_PARTICIPATION_FOR_400 = {
    "example": {
        "non_field_errors": [
            f"Поля {UNIQUE_CONSTRAINT_FIELDS_FOR_PARTICIPATION} "
            f"должны производить массив с уникальными значениями."
        ],
        "year": [
            "Обязательное поле.",
            "Убедитесь, что это значение больше либо равно 1900.",
            "Убедитесь, что это значение меньше либо равно "
            f"{timezone.now().year}.",
        ],
        ...
        "birthday": [
            "Обязательное поле.",
            "Неправильный формат date. "
            "Используйте один из этих форматов: YYYY-MM-DD.",
        ],
        "phone_number": [
