...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='play',
            name='programs',
            field=models.ManyToManyField(help_text='Для пьес Любимовки должна быть выбрана хотя бы одна Программа.', related_name='plays', to='library.ProgramType', verbose_name='Программа', blank=True),
        ),
