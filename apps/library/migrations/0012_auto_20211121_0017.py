# Generated by Django 3.2.9 on 2021-11-21 00:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='teammember',
            name='performance',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='performance_persons', to='library.performance', verbose_name='Спектакль'),
        ),
        migrations.AddField(
            model_name='teammember',
            name='person',
