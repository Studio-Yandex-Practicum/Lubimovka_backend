...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='performance',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images_in_block', to='afisha.performance', verbose_name='Изображения спектакля'),
        ),
        migrations.AlterField(
            model_name='performancemediareview',
            name='performance',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='media_reviews', to='afisha.performance', verbose_name='Спектакль'),
        ),
        migrations.AlterField(
            model_name='performancereview',
            name='performance',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reviews', to='afisha.performance', verbose_name='Спектакль'),
        ),
        migrations.AlterField(
