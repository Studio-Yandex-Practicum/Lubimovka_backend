...
import apps.core.utilities.file
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='participationapplicationfestival',
            name='file',
            field=models.FileField(upload_to=apps.core.utilities.file.generate_class_name_path, validators=[django.core.validators.FileExtensionValidator(['doc', 'docx', 'txt', 'odt', 'pdf'])], verbose_name='Файл'),
        ),
