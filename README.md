...
- волонтёры
- команды фестиваля
- пользователи-админы и редакторы (для входа используем ник admin_X (где Х двузначное число в диапазоне [00, 04]) или editor_X (X в диапазоне [05, 09]) или journalist_X (X в диапазоне [10, 14]) и дефолтный пароль "pass")
