...
- волонтёры
- команды фестиваля
- пользователи-админы, редакторы и наблюдатели (для входа используем: admin_X (где Х - в диапазоне от 00 до 04), editor_X (где Х - в диапазоне от 05 до 09), observer_X (где Х - в диапазоне от 10 до 11) и дефолтный пароль "pass")
